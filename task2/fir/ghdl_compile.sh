...
ghdl -i --workdir=work vhdl/add_shl_shr_shru_sub.vhdl
ghdl -i --workdir=work vhdl/mul.vhdl
...
ghdl -i --workdir=work gcu_ic/output_socket_4_1.vhdl
...
ghdl -i --workdir=work gcu_ic/input_socket_4.vhdl
